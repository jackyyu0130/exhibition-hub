...
[`REPLACEMENT_GUIDE_V4.8_ZH-TW.md`](REPLACEMENT_GUIDE_V4.8_ZH-TW.md)。
...
- Hero 文案使用「展覽／是城市寫給你的信」，副標題固定分成兩行；桌機 Hero 強制回到與下方內容一致的 1200px 置中容器。
- Hero 左側文字在容器內再內縮 12px；右側拼貼最大寬度 680px、高度 432px，讓畫面兩側都有完整留白。
- 票券舞台最大寬度縮至 590px，三張票券不再橫向拉得過長。
- Hero 網格改為暖白、淡奶茶與淺木棕漸層；附近展覽區同步降低成淡奶茶色帶。
