...
[`REPLACEMENT_GUIDE_V4.5_ZH-TW.md`](REPLACEMENT_GUIDE_V4.5_ZH-TW.md)。
...
- Hero 文案使用「展覽／是城市寫給你的信」，副標題固定分成兩行；桌機 Hero 恢復約 470px 的舒展高度，右側紙張拼貼從分隔線一路鋪到瀏覽器右緣。
