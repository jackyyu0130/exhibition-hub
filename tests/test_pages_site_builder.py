...
class PagesSiteBuilderTests(unittest.TestCase):
    def test_builder_deploys_only_public_site_files(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            for filename in (
                "taiwan_venue_matrix.json",
                "venue_matrix_manifest.json",
                "venue_matrix_north.json",
                "venue_matrix_west.json",
                "venue_matrix_south.json",
                "venue_matrix_east.json",
            ):
            ...
            self.assertTrue((output / "data/venue_matrix_north.json").exists())
