...
MANIFEST = json.loads((ROOT / "MANIFEST_V6.5.0-R4.json").read_text(encoding="utf-8"))


class V650R2CumulativeReleaseTests(unittest.TestCase):
    def test_r4_cache_bust_is_applied_to_all_frontend_assets(self):
        for marker in (
    ...
    def test_release_metadata_identifies_refinement_r4(self):
        self.assertIn("V6.5.0-R4", VERSION)
        self.assertEqual(MANIFEST["version"], "6.5.0-R4")
