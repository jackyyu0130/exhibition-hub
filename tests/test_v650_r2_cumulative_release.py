...
MANIFEST = json.loads((ROOT / "MANIFEST_V6.5.0-R6.json").read_text(encoding="utf-8"))
...
class V650R2CumulativeReleaseTests(unittest.TestCase):
    ...
    def test_release_metadata_identifies_refinement_r6(self):
        self.assertIn("V6.5.0-R6", VERSION)
        self.assertEqual(MANIFEST["version"], "6.5.0-R6")
