...
FREE_PATTERN = re.compile(
    r"免費入場|免費參觀|免費参觀|免費參加|免費體驗|免費入館|免費開放|自由入場|開放參觀|"
    r"不收費|免費入園|免門票|全面免費|免費展覽|免費活動|無需門票|無料"
)
PRICE_PATTERN = re.compile(
    r"(?:票價|全票|門票|定價|單人票|平日票|假日票|早鳥票|優惠票|學生票|參觀費|入場費|套票|"
    r"優待票|敬老票|團體票|兒童票|愛心票|軍警票|一般票|預售票|現場票|指定席|自由席|"
    r"個人票|語音導覽套票|均一價|每人)"
...
# 場館鄰近捷運資訊（僅供參考，出口與步行時間可能因場館/捷運出入口調整而有變動）
# 沒有捷運可達或距離較遠的場館，值留空字串，前端會顯示「建議轉乘公車」之類的提示
VENUE_TRANSIT_INFO = {
    "台北市立美術館": "捷運淡水信義線圓山站1號出口，步行約10分鐘",
    "國立歷史博物館": "捷運松山新店線小南門站3號出口，步行約10分鐘",
    "國立臺灣博物館": "捷運台北車站M8出口，步行約5分鐘",
    "台北當代藝術館": "捷運中山站R3出口，步行約5分鐘",
    "華山1914文化創意產業園區": "捷運忠孝新生站1號出口，步行約5分鐘",
    "松山文創園區": "捷運國父紀念館站5號出口，步行約10分鐘",
    "空總臺灣當代文化實驗場": "捷運忠孝新生站1號出口，步行約10分鐘",
    "國父紀念館": "捷運國父紀念館站2號出口即達",
    "中正紀念堂": "捷運中正紀念堂站5號出口即達",
    "國家兩廳院": "捷運中正紀念堂站5號出口，步行約5分鐘",
    "台北流行音樂中心": "捷運南港站2號出口，步行約8分鐘",
    "三創生活園區": "捷運台北車站M8出口，步行約5分鐘",
    "南港展覽館": "捷運南港展覽館站直達",
    "高雄市立美術館": "高雄捷運美術館站，步行約15分鐘",
    "衛武營國家藝術文化中心": "高雄捷運衛武營站2號出口即達",
    "駁二藝術特區": "高雄捷運鹽埕埔站1號出口，步行約10分鐘",
    "高雄市電影館": "高雄捷運鹽埕埔站，步行約10分鐘",
}
...
def main():
    ...
    # 場館名稱統一收斂（西4館、西5-1館 -> 統一顯示成正式場館名稱），並附上捷運交通資訊
    for event in events:
        event["locationName"] = canonical_venue_name(event["locationName"])
        event["transitInfo"] = VENUE_TRANSIT_INFO.get(event["locationName"], "")
